...
module.exports = {
  input: {
    path: "./arches_abac_permissions/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./arches_abac_permissions/locale", // output path of all created files
